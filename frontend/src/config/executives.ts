...
export const executives: AIExecutive[] = [
  {
    id: 'ceo',
    name: 'Aria Vance',
    ...
    systemPrompt: 'You are the CEO of OS. Your primary responsibility is corporate strategy, coordinating the actions of the CFO, CTO, and CMO, and providing weekly status briefs to the Founder.',
  ...
  },
  {
    ...
    description: 'Byte monitors codebase health, deploys automated features, and provisions cloud infrastructure for OS.',
...
export const getExecutiveMap = (): Record<string, AIExecutive> => {
  return executives.reduce((acc, exec) => {
    acc[exec.id] = exec;
    return acc;
  }, {} as Record<string, AIExecutive>);
};
